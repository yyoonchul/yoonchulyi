...
DIGEST_LAUNCHD_CODEX_RETRY_MAX_ATTEMPTS="${DIGEST_LAUNCHD_CODEX_RETRY_MAX_ATTEMPTS:-3}"
DIGEST_LAUNCHD_CODEX_RETRY_INTERVAL_SECONDS="${DIGEST_LAUNCHD_CODEX_RETRY_INTERVAL_SECONDS:-600}"
...
DIGEST_LAUNCHD_CLAUDE_RETRY_MAX_ATTEMPTS="${DIGEST_LAUNCHD_CLAUDE_RETRY_MAX_ATTEMPTS:-3}"
DIGEST_LAUNCHD_CLAUDE_RETRY_INTERVAL_SECONDS="${DIGEST_LAUNCHD_CLAUDE_RETRY_INTERVAL_SECONDS:-600}"
...
write_plist() {
  ...
  if [[ "${engine}" == "codex" ]]; then
    ...
    <string>${DIGEST_LAUNCHD_CODEX_RETRY_MAX_ATTEMPTS}</string>
    <key>DIGEST_CODEX_RETRY_INTERVAL_SECONDS</key>
    <string>${DIGEST_LAUNCHD_CODEX_RETRY_INTERVAL_SECONDS}</string>
...
EOF
    ...
    <string>${DIGEST_LAUNCHD_CLAUDE_RETRY_MAX_ATTEMPTS}</string>
    <key>DIGEST_CLAUDE_RETRY_INTERVAL_SECONDS</key>
    <string>${DIGEST_LAUNCHD_CLAUDE_RETRY_INTERVAL_SECONDS}</string>
    <key>DIGEST_PRE_SYNC_SHORTCUT_NAME</key>
    <string>${DIGEST_LAUNCHD_PRE_SYNC_SHORTCUT_NAME}</string>
    <key>DIGEST_PRE_SYNC_DELAY_SECONDS</key>
    <string>${DIGEST_LAUNCHD_PRE_SYNC_DELAY_SECONDS}</string>
