...
|---|---|---|
| 오픈AI, 새로운 추론 모델 공개 | AI Models | `OpenAI` |
| Gemini 3.1 Flash Lite 장문 컨텍스트 | AI Infrastructure | `Google Gemini` |
| 머스크의 xAI, 120억 달러 추가 유치 | Funding | `xAI` |
| 애플 비전프로 판매 부진 | Consumer Tech | `Apple Vision Pro` |
| EU AI법 시행 지연 | Policy | `European Union` |

## Constraints

- Do not output anything other than the JSON object.
- Do not include markdown code fences in the saved file.
- Keep the article array length equal to the article count exactly — the renderer maps by index.
